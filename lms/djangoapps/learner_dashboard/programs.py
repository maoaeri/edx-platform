...
from lms.djangoapps.learner_dashboard.utils import b2c_subscriptions_is_enabled, program_tab_view_is_enabled
...
class ProgramsFragmentView(EdxFragmentView):
    ...
    def render_to_fragment(self, request, **kwargs):
        ...
        b2c_subscriptions_enabled = b2c_subscriptions_is_enabled()
        program_subscription_data = get_programs_subscription_data(user) if b2c_subscriptions_enabled else []
        ...
        context = {
            ...
            'b2c_subscriptions_is_enabled': b2c_subscriptions_enabled,
        }
